...
For checks that don't need a live session, use the in-process [testing framework](https://docs.livekit.io/agents/start/testing/). Run the tests with `pnpm test`; `src/workflow.test.ts` covers the room-bound workflow client.
